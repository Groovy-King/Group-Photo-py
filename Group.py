...
class Group:
    def __init__(self, galaxy, properties):
        """
            Must inlcude M500 in the properties dictionary, and the galaxy must have a redshift (pos[2]) for the calculations to work.
        """
        self.galaxy = galaxy
        self.pos = galaxy.pos
    ...
    def NFW_cylinder(self, galaxies):
        try:
            ...
            H = self.properties["H"]
        r200 = self.properties["r200"]
        sigma_z = self.properties["sigma_z"]
        Da = self.properties["Da"]
    ...
    def _NFW_Sigma(self, r):
        ...
        try:
            ...
            rho_crit = self.properties["rho_crit"]
        except KeyError:
            self.compute_properties()
            r200 = self.properties["r200"]
            c200 = self.properties["c200"]
    ...
    def compute_properties(self):
        ...
        self.properties["sigma_v"] = sigma_v.to(u.km / u.s)

        sigma_z =  (1 + z) * sigma_v / c
        self.properties["sigma_z"] = sigma_z.to(u.dimensionless_unscaled)
        return
